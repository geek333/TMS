...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
     ...
     <!-- include sidepanel.jsp -->
     <jsp:include page="${request.contextPath}/includes/sidepanel.jsp"/>
      <!-- partial -->
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2018 <a href="£" target="_blank">rajesh</a>. All rights reserved.</span>
           </div>
        </footer>
        <!-- partial -->
      </div>
